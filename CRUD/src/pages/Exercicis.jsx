...
export default function Exercicis({exercicis}) {
  ...
  const [idBorrar, setidioBorrar] = useState(false);
          ...
          {exercicis && exercicis.map(exercici => (
                      <div key={exercici[0]} className="card">
                          ...
                          <div className="div-svg">
                              ...
                              <div className="div-edit-delete"> 
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="borrar" onClick={()=>setidioBorrar(exercici[0] + '')}>
              ...
              { idBorrar && 
                  <div className="confirmacio-borrar-exercici">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="tancar-finestra" onClick={()=>setidioBorrar(null)}>
